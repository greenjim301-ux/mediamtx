...
// APIForwardDestTypeSpecific contains type-specific state.
type APIForwardDestTypeSpecific interface {
	apiForwardDestTypeSpecific()
}

// APIForwardDestTypeSpecificRTMP contains type-specific state of RTMP forward destinations.
type APIForwardDestTypeSpecificRTMP struct {
	RemoteAddr    string `json:"remoteAddr"`
	InboundBytes  uint64 `json:"inboundBytes"`
	OutboundBytes uint64 `json:"outboundBytes"`
}

func (*APIForwardDestTypeSpecificRTMP) apiForwardDestTypeSpecific() {}

// APIForwardDestTypeSpecificMoQ contains type-specific state of MoQ forward destinations.
type APIForwardDestTypeSpecificMoQ struct {
	Transport     string `json:"transport"`
	OutboundBytes uint64 `json:"outboundBytes"`
}

func (*APIForwardDestTypeSpecificMoQ) apiForwardDestTypeSpecific() {}

// APIForwardDestTypeSpecificRTSP contains type-specific state of RTSP forward destinations.
type APIForwardDestTypeSpecificRTSP struct {
	RemoteAddr string `json:"remoteAddr"`
	Transport  string `json:"transport"`
...
func (*APIForwardDestTypeSpecificRTSP) apiForwardDestTypeSpecific() {}

// APIForwardDestTypeSpecificSRT contains type-specific state of SRT forward destinations.
type APIForwardDestTypeSpecificSRT struct {
	RemoteAddr string `json:"remoteAddr"`
...
func (*APIForwardDestTypeSpecificSRT) apiForwardDestTypeSpecific() {}

// APIForwardDestTypeSpecificWebRTC contains type-specific state of WebRTC forward destinations.
type APIForwardDestTypeSpecificWebRTC struct {
	RemoteAddr                string  `json:"remoteAddr"`
...
func (*APIForwardDestTypeSpecificWebRTC) apiForwardDestTypeSpecific() {}
...
type APIForwardDest struct {
	...
	OutboundBytes uint64                     `json:"outboundBytes"`
	TypeSpecific  APIForwardDestTypeSpecific `json:"typeSpecific"`
